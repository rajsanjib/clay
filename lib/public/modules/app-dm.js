...
function showMateOnboarding(callback) {
  ...
  overlay.innerHTML =
    '<div class="mate-onboarding-card">' +
      '<h2 class="mate-onboarding-title">Meet your Agents</h2>' +
      '<p class="mate-onboarding-desc">' +
        'Agents are AI teammates powered by your Claude Code.<br>Each one has a distinct role, builds its own knowledge, and gets sharper over time.' +
      '</p>' +
