...
function updateFooter() {
  ...
  footerEl.innerHTML =
    '<a href="https://github.com/chadbyte/clay" target="_blank" rel="noopener" class="cmd-palette-brand"><img src="favicon-banded.png" width="13" height="13" alt="">Claude ' + versionText + '</a>' +
...
function renderHome(filter) {
  ...
  if (filteredMates.length > 0) {
    html += '<div class="cmd-palette-group-label">Agents</div>';
