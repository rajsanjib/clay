...
function showBanner(notif, autoDismissMs) {
  ...
  var iconHtmlStr = userMentionAvatarSrc
    ...
    : isAuthRequired
      ? '<img src="/icon-banded-76.png" width="32" height="32" alt="Claude" style="border-radius:8px">'
      : projectIcon
...
export function showUpdateBanner(msg) {
  ...
  banner.innerHTML =
    '<div class="notif-banner-icon"><img src="/icon-banded-76.png" width="32" height="32" alt="Claude" style="border-radius:8px"></div>' +
    '<div class="notif-banner-body">' +
      '<div class="notif-banner-project">CLAY</div>' +
